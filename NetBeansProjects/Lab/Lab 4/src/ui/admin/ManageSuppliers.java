...
//    private JTable tblSuppliers;
    ...
    public void refreshTable() {
        ...
        model.setRowCount(0);
        Iterator var2 = this.supplierDirectory.getSupplierList().iterator();

        while(var2.hasNext()) {
            Supplier s = (Supplier)var2.next();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        //int i=1;
        AddSupplier as = new AddSupplier(this.userProcessContainer, this.supplierDirectory);
        this.userProcessContainer.add("AddSupplier", as);
