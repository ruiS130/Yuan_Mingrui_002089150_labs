...
//    private JPanel mainWorkArea;
    ...
    private void setLoginScreen() {
        LoginScreen ls = new LoginScreen(this.mainWorkArea, this.supplierDirectory);
        this.mainWorkArea.add("LoginScreen", ls);
        CardLayout layout = (CardLayout)this.mainWorkArea.getLayout();
        layout.next(this.mainWorkArea);
    }

    private void populateDemoData() {
        Supplier bestBuy = this.supplierDirectory.addSupplier();
